...
#define TRACK_CENTER_DIRECT_SMALL_RATIO 0.16f
#define TRACK_CENTER_DIRECT_SMALL_MIN   22
#define TRACK_CENTER_DIRECT_MID_RATIO   0.40f
#define TRACK_CENTER_DIRECT_MID_MIN     54
#define TRACK_EDGE_DIRECT_RATIO         0.60f
#define TRACK_EDGE_DIRECT_MIN           86
...
#define TRACK_CTRL_POS_FILTER_ALPHA   0.52f
#define TRACK_CTRL_D_FILTER_ALPHA     0.45f
#define TRACK_CTRL_DEV_STEP_LIMIT     26
#define TRACK_CTRL_OFFCENTER_BOOST    1.18f

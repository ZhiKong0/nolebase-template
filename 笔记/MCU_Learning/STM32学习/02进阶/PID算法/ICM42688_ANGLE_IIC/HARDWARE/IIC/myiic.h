...
//IO方向设置
#define SDA_IN()  {GPIOB->CRH&=0XFF0FFFFF;GPIOB->CRH|=0x00400000;}
...
#define SCL_H         GPIOB->BSRR = GPIO_Pin_12 /* GPIO_SetBits(GPIOB , GPIO_Pin_12)   */
#define SCL_L         GPIOB->BRR  = GPIO_Pin_12 /* GPIO_ResetBits(GPIOB , GPIO_Pin_12) */

#define SDA_H         GPIOB->BSRR = GPIO_Pin_13 /* GPIO_SetBits(GPIOB , GPIO_Pin_13)   */
#define SDA_L         GPIOB->BRR  = GPIO_Pin_13 /* GPIO_ResetBits(GPIOB , GPIO_Pin_13) */

#define SCL_read      GPIOB->IDR  & GPIO_Pin_12 /* GPIO_ReadInputDataBit(GPIOB , GPIO_Pin_12) */
#define SDA_read      GPIOB->IDR  & GPIO_Pin_13 /* GPIO_ReadInputDataBit(GPIOB , GPIO_Pin_13) */

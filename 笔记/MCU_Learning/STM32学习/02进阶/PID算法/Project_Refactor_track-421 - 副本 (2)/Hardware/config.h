...
#define TRACK_DYNAMIC_STEER_TRIM_DEFAULT 4.0f
...
#define TRACK_CENTER_SINGLE_ERROR 0.72f
#define TRACK_CENTER_ADJ_ERROR 2.10f
#define TRACK_CENTER_MID_ERROR 4.40f
#define TRACK_CENTER_EDGE_ERROR 6.80f
#define TRACK_SIGN_HYSTERESIS_WINDOW 1.20f

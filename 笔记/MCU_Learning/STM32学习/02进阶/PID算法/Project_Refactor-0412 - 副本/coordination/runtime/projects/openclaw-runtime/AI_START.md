...
last_updated: 2026-04-12T13:13:52.8071710+08:00
---
# AI Start
...
- Default branch: `main`
- Baseline version: `L0-20260412-131238`
...
5. use `coordination\bin\coord-read-stream.cmd -ProjectId openclaw-runtime -AgentId <agent-id> -OtherAgentsOnly -IncludeSessionHeads` for unread live deltas
...
- Session heads: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\STREAM_LOG\SESSION_HEADS.json`
- Latest digest: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\CHANGELOG_TIER\L3_DIGEST\latest_summary.md`
- Stream source: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\STREAM_LOG\STREAM.jsonl`
- Newest stream summary: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\STREAM_LOG\NEWEST_ENTRY.json`
- Tail summary window: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\STREAM_LOG\LATEST_TAIL.json`
- State event log: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\state\events\STATE_EVENTS.jsonl`
- Transactions root: `E:\OpenClaw\coordination\runtime\projects\openclaw-runtime\state\transactions`
...
- STREAM: `coordination\bin\coord-read-stream.cmd -ProjectId openclaw-runtime -AgentId <agent-id> -OtherAgentsOnly -IncludeSessionHeads`

...
5. Follow <PROJECT_COORDINATION_PATH>\AI_START.md exactly. Its minimal chain starts with `LIVE_STATE_BOARD.md`, `STREAM_LOG/SESSION_HEADS.json`, `L3_DIGEST/latest_summary.md`, `L1_ACTIVE/ACTIVE_SESSIONS.json`, and `STREAM_LOG/NEWEST_ENTRY.json`.
...
- Poll incremental updates with `coordination\bin\coord-read-stream.cmd -ProjectId <PROJECT_ID> -AgentId <AGENT_ID> -OtherAgentsOnly -IncludeSessionHeads`.

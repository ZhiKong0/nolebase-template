...
#define PID_STRAIGHT_HEADING_KI  0.20f
#define PID_STRAIGHT_HEADING_KD  0.35f
#define HEADING_INTEGRAL_ZONE    1.5f   /* deg: full ki inside, 30% outside (anti-windup) */
...
#define HEADING_INTEGRAL_ATTEN   0.3f   /* ki multiplier when |headingErr| > INTEGRAL_ZONE */

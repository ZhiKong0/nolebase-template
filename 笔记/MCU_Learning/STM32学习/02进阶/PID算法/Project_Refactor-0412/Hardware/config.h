...
#define PID_TRACK_SPEED_TARGET   20.0f   /* 循迹模式目标速度 (串口 #SPD= 可运行时修改) */
...
#define TRACK_TURN_PWM_FAST      120     /* CSR 通用找线外轮PWM: 收一点动量, 减少过转 */
#define TRACK_TURN_PWM_SLOW      90     /* CSR 通用找线内轮PWM */
#define TRACK_RIGHT_ANGLE_TURN_PWM_FAST 115 /* 直角专用找线外轮PWM: 再降一点, 减少过弯动量 */
#define TRACK_RIGHT_ANGLE_TURN_PWM_SLOW 70  /* 直角专用找线内轮PWM: 减小反转/反向强度 */
...
#define TRACK_CROSS_BYPASS_MIN_COUNT 4   /* 交叉直行绕过最少亮灯数 */
#define TRACK_CROSS_BYPASS_HOLD_MS 160   /* 交叉直行绕过保持时间 */

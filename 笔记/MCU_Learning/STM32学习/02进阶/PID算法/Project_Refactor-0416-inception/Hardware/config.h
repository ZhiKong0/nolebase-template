...
#define PID_TRACK_SPEED_TARGET   22.0f   /* 循迹模式目标速度 (串口 #SPD= 可运行时修改) */
...
#define PID_TRACK_LINE_KP        0.24f   /* 提高回线约束力: 串口试跑 0.24 下回线更快, 暂未见明显摆动恶化 */
#define PID_TRACK_LINE_KD        2.2f    /* 轻微提高阻尼, 配合更强P抑制回线后的反复摆动 */

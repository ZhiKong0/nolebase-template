...
static const TuneRuntime_t s_tuneDefaults = {
    ...
    {
        TRACK_EDGE_ENABLE,
        TRACK_EDGE_INNER_SENSOR_GAIN,
        TRACK_EDGE_OUTER_SENSOR_GAIN,
        TRACK_EDGE_EDGE_SENSOR_GAIN,
        TRACK_EDGE_LINE_KP_SCALE,
        TRACK_EDGE_YAW_LIMIT,
        TRACK_EDGE_DIFF_RATIO,
        TRACK_EDGE_DIFF_MIN,
        TRACK_EDGE_SPEED_SCALE_MIN,
        TRACK_EDGE_TARGET_POS,
        TRACK_EDGE_RELEASE_POS,
        TRACK_EDGE_LOSS_HOLD_MS
    },
    {
        TRACK_SCURVE_ENABLE,
        TRACK_SCURVE_ENTER_GRACE_MS,
        TRACK_SCURVE_ENTER_CONFIRM_COUNT,
        ...
        TRACK_SCURVE_SIDE_TARGET_ENTRY,
        TRACK_SCURVE_SIDE_TARGET_LOCK,
        TRACK_SCURVE_SIDE_TARGET_OUTER,
        TRACK_SCURVE_ENTRY_BOOST_FRAMES,
        TRACK_SCURVE_ENTRY_LINE_KP_SCALE,
        TRACK_SCURVE_ENTRY_YAW_LIMIT,
        TRACK_SCURVE_ENTRY_DIFF_RATIO,
        TRACK_SCURVE_ENTRY_DIFF_MIN,
        TRACK_SCURVE_LINE_KP_SCALE,
        TRACK_SCURVE_LOCK_LINE_KP_SCALE,
        TRACK_SCURVE_YAW_LIMIT,
        TRACK_SCURVE_LOCK_YAW_LIMIT,
        TRACK_SCURVE_DIFF_RATIO,
        TRACK_SCURVE_LOCK_DIFF_RATIO,
        TRACK_SCURVE_DIFF_MIN,
        TRACK_SCURVE_LOCK_DIFF_MIN,
...
static const TuneParamMeta_t s_paramTable[] = {
    ...
    { "track.edge.enable",            "track_edge",       "u32", "uint32_t", "bool",     TUNE_PARAM_U32, TUNE_OFF(trackEdge.enabled),           0.0f,    1.0f,  1.0f, 1.0f,1.0f,0u },
    { "track.edge.inner_sensor_gain", "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.innerSensorGain),   0.0f,    3.0f,  0.01f,0.001f,1.0f,0u },
    { "track.edge.outer_sensor_gain", "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.outerSensorGain),   0.0f,    4.0f,  0.01f,0.001f,1.0f,0u },
    { "track.edge.edge_sensor_gain",  "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.edgeSensorGain),    0.0f,    5.0f,  0.01f,0.001f,1.0f,0u },
    { "track.edge.line_kp_scale",     "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.lineKpScale),       0.5f,    3.0f,  0.05f,0.01f,1.0f,0u },
    { "track.edge.yaw_limit",         "track_edge",       "f32", "float",    "deg",      TUNE_PARAM_F32, TUNE_OFF(trackEdge.yawLimit),          0.0f,   70.0f,  0.5f, 0.1f,1.0f,0u },
    { "track.edge.diff_ratio",        "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.diffRatio),         0.1f,    1.0f,  0.01f,0.001f,1.0f,0u },
    { "track.edge.diff_min",          "track_edge",       "f32", "float",    "pwm",      TUNE_PARAM_F32, TUNE_OFF(trackEdge.diffMin),           0.0f,  200.0f,  1.0f, 1.0f,1.0f,0u },
    { "track.edge.speed_scale_min",   "track_edge",       "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackEdge.speedScaleMin),     0.0f,    1.0f,  0.01f,0.001f,1.0f,0u },
    { "track.edge.target_pos",        "track_edge",       "f32", "float",    "pos",      TUNE_PARAM_F32, TUNE_OFF(trackEdge.targetPos),         0.20f,   2.50f, 0.05f,0.01f,1.0f,0u },
    { "track.edge.release_pos",       "track_edge",       "f32", "float",    "pos",      TUNE_PARAM_F32, TUNE_OFF(trackEdge.releasePos),        0.0f,    3.0f,  0.05f,0.01f,1.0f,0u },
    { "track.edge.loss_hold_ms",      "track_edge",       "u32", "uint32_t", "ms",       TUNE_PARAM_U32, TUNE_OFF(trackEdge.lossHoldMs),        0.0f, 1000.0f, 5.0f, 1.0f,1.0f,0u },

    { "track.scurve.enable",          "track_scurve",     "u32", "uint32_t", "bool",     TUNE_PARAM_U32, TUNE_OFF(trackSCurve.enabled),          0.0f,    1.0f,   1.0f, 1.0f,1.0f,0u },
    { "track.scurve.enter_grace_ms",  "track_scurve",     "u32", "uint32_t", "ms",       TUNE_PARAM_U32, TUNE_OFF(trackSCurve.enterGraceMs),     0.0f, 3000.0f, 10.0f,1.0f,1.0f,0u },
    { "track.scurve.enter_confirm_count", "track_scurve","u32", "uint32_t", "count",    TUNE_PARAM_U32, TUNE_OFF(trackSCurve.enterConfirmCount), 1.0f, 10.0f, 1.0f,1.0f,1.0f,0u },
    ...
    { "track.scurve.side_target_entry",  "track_scurve",  "f32", "float",    "pos",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.sideTargetEntry),   0.5f, 3.5f, 0.05f, 0.01f,1.0f,0u },
    { "track.scurve.side_target_lock",   "track_scurve",  "f32", "float",    "pos",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.sideTargetLock),    0.5f, 3.5f, 0.05f, 0.01f,1.0f,0u },
    ...
    { "track.scurve.entry_boost_frames", "track_scurve",  "u32", "uint32_t", "count",    TUNE_PARAM_U32, TUNE_OFF(trackSCurve.entryBoostFrames), 0.0f, 20.0f, 1.0f,1.0f,1.0f,0u },
    { "track.scurve.entry_line_kp_scale","track_scurve",  "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackSCurve.entryLineKpScale), 0.5f, 4.0f, 0.05f, 0.01f,1.0f,0u },
    { "track.scurve.entry_yaw_limit",    "track_scurve",  "f32", "float",    "deg",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.entryYawLimit),    0.0f, 80.0f, 0.5f, 0.1f,1.0f,0u },
    { "track.scurve.entry_diff_ratio",   "track_scurve",  "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackSCurve.entryDiffRatio),   0.1f, 1.0f, 0.01f, 0.001f,1.0f,0u },
    { "track.scurve.entry_diff_min",     "track_scurve",  "f32", "float",    "pwm",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.entryDiffMin),     0.0f, 220.0f, 1.0f, 1.0f,1.0f,0u },
    ...
    { "track.scurve.lock_line_kp_scale", "track_scurve",   "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackSCurve.lockLineKpScale),  0.5f,    3.5f,  0.05f, 0.01f,1.0f,0u },
    ...
    { "track.scurve.lock_yaw_limit",  "track_scurve",     "f32", "float",    "deg",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.lockYawLimit),     0.0f,   80.0f,  0.5f,  0.1f, 1.0f,0u },
    ...
    { "track.scurve.lock_diff_ratio", "track_scurve",     "f32", "float",    "ratio",    TUNE_PARAM_F32, TUNE_OFF(trackSCurve.lockDiffRatio),    0.1f,    1.0f,  0.01f, 0.001f,1.0f,0u },
    ...
    { "track.scurve.lock_diff_min",   "track_scurve",     "f32", "float",    "pwm",      TUNE_PARAM_F32, TUNE_OFF(trackSCurve.lockDiffMin),      0.0f,  220.0f,  1.0f,  1.0f, 1.0f,0u },
